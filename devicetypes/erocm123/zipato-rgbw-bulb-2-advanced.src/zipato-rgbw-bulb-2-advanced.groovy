...
metadata {
	definition (name: "Zipato RGBW Bulb 2 (Advanced)", namespace: "erocm123", author: "Eric Maycock", vid:"generic-rgbw-color-bulb") {
        ...
        fingerprint mfr: "0131", prod: "0002", model: "0003", deviceJoinName: "Zipato Bulb 2" // Zipato Bulb 2
...
def zwaveEvent(physicalgraph.zwave.commands.securityv1.SecurityMessageEncapsulation cmd) {
	def encapsulatedCommand = cmd.encapsulatedCommand([0x20: 1, 0x84: 1, 0x70: 1])
...
def on1() {
    ...
    cmds << zwave.configurationV1.configurationSet(configurationValue: integer2Cmd(1, 1), parameterNumber: 2, size: 1)
    cmds << zwave.configurationV1.configurationSet(configurationValue: integer2Cmd(0, 1), parameterNumber: 4, size: 1)
    cmds << zwave.configurationV1.configurationSet(configurationValue: integer2Cmd(127, 1), parameterNumber: 3, size: 1)
...
def on2() {
    ...
    def cmds = []
    if (device.currentValue('switch') != "on") cmds << zwave.basicV1.basicSet(value: 0xFF)
    cmds << zwave.configurationV1.configurationSet(configurationValue: integer2Cmd(25, 1), parameterNumber: 2, size: 1)
    cmds << zwave.configurationV1.configurationSet(configurationValue: integer2Cmd(0, 1), parameterNumber: 4, size: 1)
    cmds << zwave.configurationV1.configurationSet(configurationValue: integer2Cmd(127, 1), parameterNumber: 3, size: 1)
    cmds << zwave.configurationV1.configurationGet(parameterNumber: 3)
    cmds << zwave.basicV1.basicGet()
...
def on3() {
    ...
    if (device.currentValue('switch') != "on") cmds << zwave.basicV1.basicSet(value: 0xFF)
    cmds << zwave.configurationV1.configurationSet(configurationValue: integer2Cmd(1, 1), parameterNumber: 2, size: 1)
    cmds << zwave.configurationV1.configurationSet(configurationValue: integer2Cmd(1, 1), parameterNumber: 4, size: 1)
    cmds << zwave.configurationV1.configurationSet(configurationValue: integer2Cmd(127, 1), parameterNumber: 3, size: 1)
    cmds << zwave.configurationV1.configurationGet(parameterNumber: 3)
    cmds << zwave.basicV1.basicGet()
	commands(cmds)
...
def on5() {
    ...
    def cmds = []
    if (device.currentValue('switch') != "on") cmds << zwave.basicV1.basicSet(value: 0xFF)
    cmds << zwave.configurationV1.configurationSet(configurationValue: integer2Cmd(settings."2".toInteger(), 1), parameterNumber: 2, size: 1)
...
def offCmd() {
    ...
    toggleTiles("all")
    def cmds = []
    cmds << zwave.configurationV1.configurationSet(scaledConfigurationValue: 0, parameterNumber: 3, size: 1)
    cmds << zwave.configurationV1.configurationGet(parameterNumber: 3)
    cmds << zwave.basicV1.basicGet()
    commands(cmds)
}
...
'''
<configuration>
  <Value type="byte" byteSize="1" index="2" label="Strobe Light Interval" min="0" max="25" value="0" setting_type="zwave" fw="">
    <Help>
...
Default: 0
    ...
    <Value type="byte" byteSize="1" index="3" label="Strobe Light Pulse Count" min="0" max="127" value="0" setting_type="preference" fw="">
    <Help>
Adjust strobe light pulse count. Values range from 0 to 25 and a special value 127 which sets infinite flashing.
Range: 0~25, 127 (Infinite)
Default: 0
    </Help>
  </Value>
      <Value type="list" byteSize="1" index="4" label="Random Strobe Colors" min="0" max="1" value="0" setting_type="zwave" fw="">
    <Help>
Range: 0~1
Default: 0 (Disabled)
    </Help>
